...
class LakeshoreMeasure(Measurement):
    ...
    def setup_figure(self):
        ...
        self.ctrl.settings.heater_output.connect_to_widget(self.ui.heater_output_progressBar)
        self.ctrl.settings.setpoint_T.connect_to_widget(self.ui.setpoint_T_doubleSpinBox)
        self.ctrl.settings.control_input.connect_to_widget(self.ui.control_input_comboBox)
        self.ctrl.settings.control_mode.connect_to_widget(self.ui.control_mode_comboBox)
        self.ctrl.settings.heater_range.connect_to_widget(self.ui.heater_range_comboBox)
        self.ctrl.settings.ramp_on.connect_to_widget(self.ui.ramp_on_checkBox)
        self.ctrl.settings.ramp_rate.connect_to_widget(self.ui.ramp_rate_doubleSpinBox)

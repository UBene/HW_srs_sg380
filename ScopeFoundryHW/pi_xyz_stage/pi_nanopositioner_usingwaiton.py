import time
from pipython import GCSDevice, pitools, PILogger, DEBUG, INFO, WARNING, ERROR, CRITICAL

PILogger.setLevel(WARNING)
SLOW_STEP_PERIOD = 0.050  # units are seconds


class PINanopositioner:

    def __init__(self, debug=False, deviceaxes=('1', '2', '3'), CONTROLLERNAME: str='E-727'):
        self.debug = debug
        if debug:
        ...
        self.pidevice.SVO(deviceaxes, [True] * self.num_axes)
    ...
    def set_pos_ax_slow(self, pos, axis):
        if self.debug:
            print("set_pos_slow_ax ", pos, axis)
...
if __name__ == '__main__':
    ...
    # for x,y,z in [ (30,1,1), (30,10,10), (30,30,30), (30,50,60), (30,25,60),
    # (30,1,1)]:

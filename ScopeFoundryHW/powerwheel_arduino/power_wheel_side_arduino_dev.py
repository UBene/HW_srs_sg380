...
class PowerWheelSideArduino(object):
    ...
    def write_steps(self,steps):
        ...
        """
        steps_corrected = steps*-1
        self.send_cmd(b'am%i' % steps_corrected)
        #print "steps ", steps
...
if __name__ == '__main__':
    W1 = PowerWheelSideArduino(debug=True);
    time.sleep(4)
    W1.write_steps(-400)
    time.sleep(4)
    W1.write_steps(400)    

...
class LucamMeasure(Measurement):
    ...
    def setup(self):
        ...
        S.New('mode', str, choices=('streaming', 'averaging', 'averaging_bg', 'snapshot'), initial='streaming')
    ...
    def setup_figure(self):
        ...
        ctr_widget = HS.New_UI(include=('connected', 'frame_rate', 'pixel_format', 'exposure'))
        ...
        channel_layout.addWidget(S.New_UI(include=('mode', 'bg_subtract', 'N_avg')))
    ...
    def update_display(self):
        ...
        saturation = img[:, :, :3].max() / 2**(8 * (self.hw.settings['pixel_format'] + 1))

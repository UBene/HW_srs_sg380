...
class LightFieldDev_IR(object):
    def __init__(self, debug = False):
        ...
        # Load experiment_IR
        self.experiment.Load('Experiment_IR')
        
        # Get file manager object
        self.file_manager = auto.LightFieldApplication.FileManager
        ...
        # print('Setting adc_quality')
        # self.set_adc_quality()
        # print('Settled adc_quality')
        # print('Setting adc_speed')
        # self.set_adc_speed()
        # print('Settled adc_speed')
        print('Setting adc_AnalogGain')
        self.set_adc_AnalogGain()
        print('Settled adc_AnalogGain')
        # print('Setting adc_EMGain')
        # self.set_adc_EMGain()
        # print('Settled adc_EMGain')
        ...
        #     self.set_custom_ROI(roi_dim_x = 0 , roi_dim_y = 0, roi_width = 1024, roi_height=1, roi_xbinning=1, roi_ybinning=1)
...
#            int_data = int_data_new/num_low
    ...
    #     self.experiment.SetValue(CameraSettings.ReadoutControlRegionsOfInterestSelection, self.roi_type_int)
    #
    #     if self.debug: print("Roi Type : {}".format(roitype))
    #
    # def set_XBinning(self, bin_width = 1):
    #     self.experiment.SetValue(CameraSettings.ReadoutControlRegionsOfInterestBinnedSensorXBinning, bin_width)
    #
    #     if self.debug: print("Bin Width : {}".format(bin_width))
    #
    # def set_YBinning(self, bin_width = 1, bin_height = 1):
    #     self.experiment.SetValue(CameraSettings.ReadoutControlRegionsOfInterestBinnedSensorYBinning, bin_height)
    #
    ...
    def set_adc_EMGain(self, gain = 1):
        ...
        self.experiment.SetValue(CameraSettings.AdcEMGain, gain)
        if self.debug: print("ADC EMGain: {}".format(gain))

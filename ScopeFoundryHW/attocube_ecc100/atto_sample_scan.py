...
class AttoSampleScan(Measurement):
    
    name = "atto_sample_scan"
    ...
    def setup(self):
        ...
        lq_params = dict(dtype=float, vmin=-10000,vmax=10000, ro=False, unit='nm' )
        ...
        self.pixel_time = self.add_logged_quantity('pixel_time', initial=0.01, unit='sec')
        # connect to gui

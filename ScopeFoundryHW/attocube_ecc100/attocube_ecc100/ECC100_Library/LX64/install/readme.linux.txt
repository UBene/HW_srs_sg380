...
1. The software is built for x86 systems.
   Builds for 32 bit and 64 bit (AMD) systems are available.
   The platform for build and test was Ubuntu 10.04 LTS
   that uses libc 2.11.1 Binary compatibility has been verified
   with other versions and other distribution families.
   There should be good chances to run the programs on other distributions.
...
5. Make sure that the program loader can find the shared libaries
   that are used by daisy. This may be achieved

...
class TimeHarpHistogramMeasure(Measurement):

    name = "timeharp_260_histogram"
    ...
    def setup(self):
        ...
        # hardware
        hw = self.hw = self.app.hardware['timeharp_260']

        # UI
        self.ui_filename = sibling_path(
            __file__, "timeharp_260_hist_measure.ui")
        ...
        S.auto_HistogramBins.connect_to_widget(
            self.ui.auto_HistogramBins_checkBox)
        ...
        hw.settings.HistogramBins.connect_to_widget(
            self.ui.HistogramBins_doubleSpinBox)
    ...
    def run(self):
        ...
        self.hw = hw = self.app.hardware['timeharp_260']
    ...
    def update_display(self):
        ...
        if not self.display_ready:
            ...
            for i in range(self.hw.enabled_channels):
                self.plotlines.append(self.plot.plot(
                    label=i, name='histogram' + str(i)))

    ...
    def update_display(self):
        ...
        if self.initial_scan_setup_plotting:
            ...
            if self.settings['collect_apd']:
                ...
                self.disp_img = np.flip(self.count_rate_map[kk,:,:].T, 1) ##Note:changed by Kaiyuan, to make display right, 07/24/2018
            elif self.settings["collect_spectrum"]:
                self.disp_img = np.flip(self.integrated_spectra_map[kk,:,:].T, 1)

...
class MotorizedStage(object):
    def __init__(self):
        ...
        self.lib = ctypes.WinDLL("Thorlabs.MotionControl.IntegratedStepperMotors.dll")
        # set up serial number variable
        self.serialNumber = c_char_p(b"55902790")  # S/N number on the mount
    ...
    def go_to_pos(self, target_deg):
        ...
        print ('Excitation Moving Time: %d s'%time_elapse)

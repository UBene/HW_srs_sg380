...
class LightFieldReadout(Measurement):

    name = "lightfield_readout"

    #ui_filename = "ScopeFoundryMeasurement/apd_optimizer.ui"
    
    def __init__(self, app):
        self.ui_filename = sibling_path(__file__, "lightfield_readout.ui")
        super(LightFieldReadout, self).__init__(app) 
    ...
    def setup_figure(self):
        ...
        self.spec_plot = self.graph_layout.addPlot(title="LightField Readout")
    ...
    def ro_acquire_data(self):
        ...
        if lf.roi_type_int == 2:
            xbin = self.lightfield_hw.settings["x_binning"] #Full sensor binned
            #print ('Binned full sensor')
        elif lf.roi_type_int == 4:
            xbin = self.lightfield_hw.settings["custom_roi_xbinning"] #custom ROI binned
        ...
        while not self.interrupt_measurement_called:
            ...
            try:
                ...
                if self.settings['MultiSpecAvg'] == False:
                    ...
                    for iMulti in range(self.settings.MultiSpecAvg_Number.val-1):

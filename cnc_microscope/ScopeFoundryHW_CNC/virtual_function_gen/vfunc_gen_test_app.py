...
class VirtualFunctionGenTestApp(BaseMicroscopeApp):
    ...
    def setup(self):
        ...
        from ScopeFoundryHW_CNC.virtual_function_gen.vfunc_gen_hw import VirtualFunctionGenHW
        self.add_hardware(VirtualFunctionGenHW(self))


        #Add Measurement components
        from ScopeFoundryHW_CNC.virtual_function_gen.sine_wave_measure import SineWavePlotMeasure

...
try:
    from ScopeFoundryEquipment.thorlabs_pm100d_Si import ThorlabsPM100D
except Exception as err:
    print("Cannot load required modules for Thorlabs Power meter: {}".format( err))


class ThorlabsPowerMeterSiHW(HardwareComponent):
    
    def setup(self):
        self.name = 'thorlabs_powermeter_Si'
        ...
        self.port = self.add_logged_quantity('port', dtype=str, initial='USB0::0x1313::0x8078::P0018401::INSTR')

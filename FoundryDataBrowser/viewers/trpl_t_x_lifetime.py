...
class TRPL_t_x_lifetime_BaseView(HyperSpectralBaseView):
    ...
    def scan_specific_setup(self):
        ...
        self.kk_start_vline = pg.InfiniteLine(QtCore.QPointF(1, 0), 90, movable=False, )
        self.kk_stop_vline = pg.InfiniteLine(QtCore.QPointF(100, 0), 90, movable=False,)
        self.tau_x_vline = pg.InfiniteLine(QtCore.QPointF(10, 0), 90, movable=False, )
    
        #self.spec_plot.addItem(self.kk_start_vline)
        #self.spec_plot.addItem(self.kk_stop_vline)
        #self.spec_plot.addItem(self.tau_x_vline)

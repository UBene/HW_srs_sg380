...
class QPulseSweepProgramGenerator(PulseProgramGenerator):
    ...
    def make_pulse_channels(self) -> [PulseBlasterChannel]:
        ...
        return [self.new_channel('uW', [uW_on_off_delay], [t_uW_duration]),
                ...
                self.new_channel('AOM', [uW_on_off_delay + t_I_delay], [t_IQ_duration]),
...
class QPulseSweep(Measurement):
    ...
    def setup(self):
        ...
        self.range = S.New_Range(
            "t_Q_delays", initials=[-100, 100, 10], unit="ns", si=True
        )
        ...
        self.pulse_generator = QPulseSweepProgramGenerator(self)
    ...
    def run(self):
        ...
        self.data['t_Q_delays'] = t_Q_delays = self.range.sweep_array
        ...
        try:
            ...
            # Run experiment
            for t_Q_delay in t_Q_delays:
                S['t_Q_delay'] = t_Q_delay
                self.pulse_generator.program_pulse_blaster_and_start()
                time.sleep(0.1)
